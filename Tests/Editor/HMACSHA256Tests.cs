    ...
    public class HMACSHA256Tests
    {
        ...
        public void TestVectorSHA256()
        {
            unsafe
            {
                ...
                // 896 bits
                var str = (FixedString512Bytes)"abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu";
                var result = new NativeArray<byte>(32, Allocator.Temp, NativeArrayOptions.UninitializedMemory);
        ...
        void ValidateHMACSHA256TestVector(byte[] key, byte[] message, ref FixedString128Bytes expectedResult)
        {
        ...
        {
            FixedString512Bytes key = "";
            for (var i = 0; i < 20; i++)
                key.Append((char)0x0b);
            FixedString512Bytes message = "Hi There";
            FixedString128Bytes expectedResult = "b0344c61d8db38535ca8afceaf0bf12b881dc200c9833da726e9376c2e32cff7";
        ...
        {
            FixedString512Bytes key = "Jefe";
            FixedString512Bytes message = "what do ya want for nothing?";
            FixedString128Bytes expectedResult = "5bdcc146bf60754e6a042426089575c75a003f089d2739839dec58b964ec3843";
        ...
        public void TestVectorHMACSHA256_3()
        {
            ...
            FixedString128Bytes expectedResult = "773ea91e36800e46854db8ebd09181a72959098b3ef8c122d9635514ced565fe";
        ...
        public void TestVectorHMACSHA256_4()
        {
            ...
            FixedString128Bytes expectedResult = "82558a389a443c0ea4cc819899f2083a85f0faa3e578f8077a2e3ff46729665b";
        ...
        public void TestVectorHMACSHA256_5()
        {
            ...
            FixedString512Bytes message = "Test Using Larger Than Block-Size Key - Hash Key First";
            FixedString128Bytes expectedResult = "60e431591ee0b67f0d8a26aacbf5b77f8e0bc6213728c5140546040f0ee37f54";
        ...
        public void TestVectorHMACSHA256_6()
        {
            ...
            FixedString512Bytes message = "This is a test using a larger than block-size key and a larger than block-size data. The key needs to be hashed before being used by the HMAC algorithm.";
            FixedString128Bytes expectedResult = "9b09ffa71b942fcb27635fbcd5b0e944bfdc63644f0713938a7f51535c3a35e2";
