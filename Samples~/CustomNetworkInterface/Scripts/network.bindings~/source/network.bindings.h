...
EXPORT_API int32_t network_set_nonblocking(int64_t socket_handle, int32_t *errorcode);
EXPORT_API int32_t network_set_blocking(int64_t socket_handle, int32_t *errorcode);

EXPORT_API int32_t network_set_send_buffer_size(int64_t handle, int size, int32_t *errorcode);
EXPORT_API int32_t network_get_send_buffer_size(int64_t handle, int *size, int32_t *errorcode);

EXPORT_API int32_t network_set_receive_buffer_size(int64_t handle, int size, int32_t *errorcode);
EXPORT_API int32_t network_get_receive_buffer_size(int64_t handle, int *size, int32_t *errorcode);
...
EXPORT_API int32_t network_set_receive_timeout(int64_t handle, int64_t timeout_msec, int32_t *errorcode);
EXPORT_API int32_t network_set_send_timeout(int64_t handle, int64_t timeout_msec, int32_t *errorcode);
